...
function Fit() {
  return <section className="or-section or-shell" id="fit">
    <div className="or-section-head or-stacked-head"><h2>OpenRouter is where my two tracks meet.</h2><p>OpenRouter needs sellers who can handle long, multistakeholder cycles and explain a technical platform to both builders and executives. I have done the commercial work and built with the underlying tools.</p></div>
...
function Thesis() {
  return <section className="or-thesis" id="perspective"><div className="or-shell or-thesis-grid">
    ...
    <div className="or-route-panel" aria-label="Illustration: teams and agents connect through a routing layer to multiple model providers">
      ...
      <div className="or-route-caption"><span>Own the operating layer.</span><span>Choose the compute path by workload.</span></div>
    </div>
  </div></section>;
}
...
function Work() {
  return <section className="or-section or-shell" id="work"><div className="or-section-head or-stacked-head"><h2>I build the systems I wish I had as a seller.</h2><p>These projects show the same working style I would bring to OpenRouter: understand the workflow, make the technical path real, and keep the result useful to the people responsible for it.</p></div>
...
function GitHubShowcase() {
  ...
  return <section className="or-github" id="github"><div className="or-shell">
    <div className="or-github-head"><h2>See the work, then the full picture.</h2><p>My public GitHub is the most direct view into what I have been building. Some customer systems and my personal harness are private; the public repositories are live here.</p><External href={githubProfile} className="or-button or-button-outline"><Github size={18}/> Open full GitHub profile <ArrowUpRight size={17}/></External></div>
